  ...
  return (
    <div className="bg-transparent relative w-full min-h-screen overflow-visible">
      ...
      >
        ...
        {/* ---------------- LEFT STACKED IMAGES ---------------- */}
        <div className="absolute left-0 top-0 h-full flex flex-col justify-start gap-10 pl-4 z-40 overflow-visible">
        ...
        <div className="absolute right-0 top-0 h-full flex flex-col justify-center items-end gap-6 pr-4 z-40 overflow-visible">
        ...
        {/* ---------------- CENTER CONTENT ---------------- */}
        <div
          className="relative z-30 flex flex-col items-center text-center w-[60%] pt-20"
          style={{ fontFamily: "ReginaBlack" }}
        >
          <h1 className="text-white text-[110px] font-bold tracking-wide leading-none mt-10"  style={{ fontFamily: "ReginaBlack" }}>
            MOLLYCLUB
          </h1>

          <p className="text-white max-w-[900px] mt-8 text-[21px] leading-[32px] opacity-95"  style={{ fontFamily: "ReginaBlack" }}>
          ...
          <button className="mt-10 px-12 py-4 bg-[#F4B816] text-black text-[20px] font-semibold rounded-full hover:bg-[#e4a415] transition-all duration-300 shadow-lg"  style={{ fontFamily: "ReginaBlack" }}>
            VIEW EVENTS
          </button>
        </div>
