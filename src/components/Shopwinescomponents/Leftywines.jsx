...
const Leftywines = () => {
  return (
    <section className="bg-[#8c9240] flex flex-col items-center py-20 px-8 min-h-screen font-serif" style={{ fontFamily: "ReginaBlack" }}>
      <h2 className="text-5xl font-bold uppercase mb-16 text-[#283618]">LEFTY WINES</h2>
        ...
        {wines.map((wine, idx) => (
          <div key={idx} className="flex flex-col items-center text-center max-w-xs">
            <div className="relative">
              ...
              />
              {wine.rating && (
                <span className="absolute top-2 right-2 bg-white text-black font-bold text-xs rounded-full px-3 py-1 whitespace-nowrap">
