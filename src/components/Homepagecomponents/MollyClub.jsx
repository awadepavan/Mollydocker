  ...
  return (
    <div className=" h-screen w-full bg-[#8d1a3a]">
      ...
      <div className="relative w-full min-h-screen flex items-center justify-center bg-cover bg-bottom overflow-visible">
        ...
        <div className="flex absolute left-0 top-1/4 lg:top-50 h-full flex-col justify-start gap-2 sm:gap-6 pl-0 sm:pl-4 z-40 overflow-visible w-[38%] sm:w-[28%] lg:w-[30%]">
          <img
            src="/Images/Homepage/figure-left-leaves-euc-2.webp"
            alt="koala"
            className="relative w-[220px] sm:w-[250px] lg:w-[350px] -translate-x-[15%] sm:-translate-x-1/2 ml-0 sm:ml-24 lg:ml-34 -mt-[30%] lg:-mt-[50%] z-50"
          />
           <img
            src="/Images/Homepage/figure-left-panther.webp"
            alt="koala"
            className="relative w-[220px] sm:w-[250px] lg:w-[350px] -translate-x-[15%] sm:-translate-x-1/2 ml-0 sm:ml-20 lg:ml-30 -mt-[30%] lg:-mt-[50%] z-50"
          />

          <img
            src="/Images/Homepage/figure-left-leaves-2.webp"
            alt="flower"
            className="w-[220px] sm:w-[250px] lg:w-[350px] -translate-x-[15%] sm:-translate-x-1/2 ml-0 sm:ml-24 lg:ml-40 -mt-10 lg:-mt-50"
          />
        </div>
        ...
        <div className="flex absolute right-0 top-0 h-full flex-col justify-center items-end gap-10 pr-0 sm:pr-4 z-40 overflow-visible w-[38%] sm:w-[28%] lg:w-[30%]">
          <img
            src="/Images/Homepage/figure-peacock-chest.webp"
            alt="acrobats"
            className="relative mt-[200px] sm:mt-[350px] lg:mt-[560px] mr-0 sm:mr-[200px] lg:mr-[350px] w-[320px] sm:w-[370px] lg:w-[750px] translate-x-[15%] sm:translate-x-1/3 z-50"
          />
        </div>
      </div>
    </div>
